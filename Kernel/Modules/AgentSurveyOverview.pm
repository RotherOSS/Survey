...
sub Run {
    ...
    if ( $Self->{Subaction} eq 'Change' ) {
        ...
        if ( $ParamObject->GetParam( Param => 'TimeSearchType' ) eq 'TimeSlot' ) {
            ...
            $SurveySearch{CreateTimeNewerDate} = "$SurveyCreateTimeStartYear-$SurveyCreateTimeStartMonth-$SurveyCreateTimeStartDay 00:00:00";

            $SurveySearch{CreateTimeOlderDate} = "$SurveyCreateTimeStopYear-$SurveyCreateTimeStopMonth-$SurveyCreateTimeStopDay 23:59:59";
