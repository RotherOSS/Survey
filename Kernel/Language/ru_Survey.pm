...
sub Data {
    ...
    $Self->{Translation}->{'Please choose a Customer property to add a condition.'} = 'Выберите <Свойство клиента>, чтобы добавить условие.';
    ...
    $Self->{Translation}->{'Trigger delete results (including vote data and requests).'} = 'Триггер удаления результатов (включая данные голосования и запросы).';
