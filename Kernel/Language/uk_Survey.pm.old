...
sub Data {
    ...
    $Self->{Translation}->{'Please choose a Customer property to add a condition.'}
        = 'Будь ласка виберіть коректно клієнта щоб додати умову';
    ...
    $Self->{Translation}->{'You have no permission for this survey or question!'}
        = 'Ви не маєте повноважень на це опитування чи запитання';
    $Self->{Translation}->{'You have no permission for this survey, question or answer!'}
        = 'Ви не маєте повноважень на це опитування, запитання чи відповідь';
    ...
    $Self->{Translation}->{'You have no permission for this survey or stats detail!'}
        = 'Ви не маєте повноважень на це опитування чи статистику';
    $Self->{Translation}->{'Stats Detail'} = 'Деталі статистики';

    # Perl Module: Kernel/Modules/AgentSurveyZoom.pm
    $Self->{Translation}->{'Can\'t set new status! No questions defined.'}
        = 'Не можливо встановити новий статус. Не визначені запитання';
    $Self->{Translation}->{'Can\'t set new status! Questions incomplete.'}
        = 'Не можливо оновити статус! Запитання не завершені';
    ...
    $Self->{Translation}->{'Defines the groups (rw) which can delete survey stats.'}
        = 'Задає групи (читання/запису) які можуть видалити статистику опитування';
    ...
    $Self->{Translation}->{'Enable or disable the send condition check for the service.'}
        = 'Ввімкнути/вимкнути перевірку умови відправки для сервісу';
    ...
    $Self->{Translation}->{'If this regex matches, no customer survey will be sent.'}
        = 'Якщо регулярний вираз визначає, жодне опитування клієнту не буде відправлено';
    ...
    $Self->{Translation}->{
        ...
        =
        'Результати, старші ніж визначена кількість днів будуть видалені. Замітка: налаштовується OTOBO Daemon Task###SurveyRequestsDelete';
    ...
    $Self->{Translation}->{'Survey limit per page for Survey Overview "Small".'}
        = 'Ліміт опитувань на сторінку для перегляду в режимі Small';
    $Self->{Translation}->{'Surveys will not be sent to the configured email addresses.'}
        = 'Опитування не будуть надсилатись на вказані email';
    ...
    $Self->{Translation}->{'Trigger delete results (including vote data and requests).'}
        = 'Тригери видалення результатів (включаючи оцінки і запити)';
    $Self->{Translation}->{'Trigger sending delayed survey requests.'}
        = 'Тригер відправки відкладених запитів опитування';
