...
sub Data {
    ...
    $Self->{Translation}->{'If this regex matches, no customer survey will be sent.'}
        = 'Se esta regex for encontrada, nenhum questionário será enviado para o cliente';
    ...
    $Self->{Translation}->{'Surveys will not be sent to the configured email addresses.'}
        = 'Os questionários não serão enviados para os endereços de e-mail configurados.';
    ...
    $Self->{Translation}->{'Trigger delete results (including vote data and requests).'}
        = 'Acionar os resultados da exclusão ( incluindo dados de voto e pedidos)';
