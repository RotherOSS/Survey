...
sub Data {
    ...
    $Self->{Translation}->{'You have no permission for this survey or stats detail!'}
        = 'Non hai i permessi per questo sondaggio o per i dettagli delle statistiche!';
    ...
    $Self->{Translation}->{'Defines the groups (rw) which can delete survey stats.'}
        = 'Definisce i gruppi (rw) che possono eliminare le statistiche del sondaggio.';
    ...
    $Self->{Translation}->{'Enable or disable the send condition check for the service.'}
        = 'Abilita o disabilita il controllo della condizione di invio per il servizio.';
    ...
    $Self->{Translation}->{'Trigger delete results (including vote data and requests).'}
        = 'Attiva i risultati dell\'eliminazione (inclusi i dati e le richieste di voto).';
