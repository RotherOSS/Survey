...
sub Data {
    ...
    $Self->{Translation}->{'Defines the groups (rw) which can delete survey stats.'}
        = 'Define los grupos (rw) que pueden eliminar las estadísticas de la encuesta.';
    ...
    $Self->{Translation}->{'If this regex matches, no customer survey will be sent.'}
        = 'Si esta expresión regular concuerda, no se enviará ninguna encuesta al cliente.';
    ...
    $Self->{Translation}->{
        ...
        =
        'Los resultados anteriores a la cantidad configurada de días serán eliminados. Nota: elimine los resultados realizados por Daemon OTOBO, antes de la activación de la configuración \'Task###SurveyRequestsDelete\'.';
    ...
    $Self->{Translation}->{'Survey limit per page for Survey Overview "Small".'}
        = 'Límite de encuestas por página para la vista general de encuesta «pequeña».';
    ...
    $Self->{Translation}->{'Trigger delete results (including vote data and requests).'}
        = 'Desencadenar resultados de eliminación (incluidos datos y solicitudes de voto).';
