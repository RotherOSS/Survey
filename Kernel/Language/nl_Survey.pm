...
sub Data {
    ...
    $Self->{Translation}->{
        ...
        =
        'Bepaalt het aantal uren dat een ticket moet zijn gesloten om een enquête te verzenden (0 betekent verzenden direct na sluiting). Opmerking: het vertraagd verzenden van enquêtes wordt gedaan door de OTOBO Daemon, voorafgaande activering van de instelling \'Daemon::SchedulerCronTaskManager::Task###SurveyRequestsSend\'.';
    ...
    $Self->{Translation}->{
        ...
        =
        'Resultaten ouder dan het geconfigureerde aantal dagen worden verwijderd. Opmerking: resultaten verwijderen wordt gedaan door de OTOBO Daemon, voorafgaande activering van de instelling \'Taak###SurveyRequestsDelete\'.';
    ...
    $Self->{Translation}->{'Trigger delete results (including vote data and requests).'}
        = 'Resultaten verwijderen activeren (inclusief stemgegevens en verzoeken).';
